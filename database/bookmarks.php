...
if(isset($_COOKIE['username']))
{
    ...
    $postsql=mysql_query("select postid,title,posttime,post.postuser,viewsnum from post,bookmarks 
...
?>
    ...
    <div class="col-md-9">
    <h2 class="text-center New User">You do not have any bookmark!</h2>
...
<div class="post-row Comment Open">
    ...
    <div class="count-box visible-lg visible-md">
        ...
        ?>
        <div class="box view">
            <div class="c"><?php echo $row[4]; ?></div>
    ...
    <div class="title-box clearfix">
        <div class="post-title">
            <a href="content.php?id=<?php echo $row[0]; ?>"><?php echo $row[1] ?></a>
        </div>
        <div class="clearfix">

            <span class="userlink text-right muted">
            written  <?php echo $row[4]?> by 
                <a href="user.php?id=<?php echo $userid;?>"><?php echo $row[3]?></a> &bull;
            </span>
            <?php 
                if($answernum!=0){                
            ?>
