...
<head>
    ...
    <link href="./picture/titletitle.png"/>
...
$result=mysql_query("select count(comment.comtitle) from comment,post where comment.comtitle=post.title and post.postuser!=comment.commentuser" );
if ($result)
