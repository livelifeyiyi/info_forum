...
if(isset($_COOKIE['username']))
{
    ...
    $usersql=mysql_query("select * from user where username='$username' ");
...
<div class="col-md-12">
    <h2 class="text-center New User">User:<?php  echo $username;?></h2>
    <hr>
</div>  
<div class="col-md-3">
    ...
    <hr>
        ...
        <h4 class="text-center">Posts by <?php  echo $username;?></h4>
    </div>
